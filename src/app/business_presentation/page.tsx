...
const ApresentacaoComercial = () => {
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6">
      <h1 className="text-3xl font-bold mb-6 text-center">Apresentação Comercial</h1>
      ...
      <a
        ...
        className={`block text-center bg-[#7747ff] text-white font-medium py-3 px-4 rounded-lg hover:bg-purple-500 transition-colors animate-pulse hover:animate-none py-4 px-10 mt-6`}
      >
        Fazer Download
      </a>
