    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-6">
      ...
      <div className="w-full max-w-4xl text-justify space-y-4">
        ...
        <p>
          ...
          integridade por meio desta política, que estabelece as diretrizes para
          prevenir práticas de corrupção e suborno em todas as suas operações.
          Esta política reflete o compromisso da empresa em manter elevados
          padrões éticos e conformidade com as legislações nacionais e
          internacionais.
        </p>
        <p>
          A Pix on Chain adota uma abordagem de tolerância zero em relação à
          corrupção, garantindo que todas as interações sejam conduzidas de
          maneira honesta e responsável. A recusa em participar de práticas
          ilícitas é incentivada e valorizada, mesmo que isso implique em perda
          de oportunidades de negócios.
        </p>

        <h2 className="text-xl font-bold">2. Escopo e Aplicabilidade</h2>
        <p>
          Esta política se aplica a todos os indivíduos e entidades envolvidas
          direta ou indiretamente nas operações da Pix on Chain, abrangendo:
        </p>
        ...
        <p>
          ...
          exterior, independentemente da localização geográfica.
        </p>

        <h2 className="text-xl font-bold">3. Definições</h2>
        <ul className="list-disc list-inside">
          <li>
            <strong>Corrupção:</strong> O abuso de poder confiado para obter
            benefícios indevidos, sejam financeiros ou não, favorecendo
            interesses próprios ou de terceiros, em detrimento das normas e
            valores éticos.
          </li>
          <li>
            <strong>Suborno:</strong> A oferta, promessa, solicitação ou
            aceitação de algo de valor como meio de influenciar ações ou
            decisões, seja no setor público ou privado, visando vantagens
            indevidas.
          </li>
          <li>
        ...
        <ul className="list-disc list-inside">
          <li>
            ...
            públicos por meio de vantagens indevidas.
          </li>
          <li>
            Todas as interações com agentes públicos devem ser transparentes e
            documentadas.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside">
          <li>
            ...
            critérios claros, éticos e objetivos.
          </li>
          <li>
            Contratos devem conter cláusulas anticorrupção, assegurando que
            terceiros também cumpram esta política.
          </li>
        </ul>
        ...
        <p>
          ...
          além de possíveis sanções legais.
        </p>

        <h2 className="text-xl font-bold">8. Legislação e Conformidade</h2>
        <ul className="list-disc list-inside">
          <li>Lei nº 12.846/2013 (Lei Anticorrupção Brasileira).</li>
          <li>Decreto nº 8.420/2015 (Regulamentação da Lei Anticorrupção).</li>
