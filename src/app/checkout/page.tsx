...
const CheckoutPage = () => {
  ...
  useEffect(() => {
    setTimeRemaining(18 * 24 * 3600 + 6 * 3600 + 34 * 60 + 55)
  ...
  const handleInvoice = async () => {
    try {
      const response = await fetch(
        "https://faas-nyc1-2ef2e6cc.doserverless.co/api/v1/namespaces/fn-3edbb181-8e97-4992-9778-0b8a1d2f1e66/actions/receber-dados-landing-page?blocking=true&result=true",
        {
          method: "POST",
          headers: {
      ...
      if (result.status === "sucesso") {
        toast.success(
          `Nota fiscal emitida com sucesso! ID: ${result.nota_fiscal.id}`,
          {
            position: "top-right",
            autoClose: 3000,
        ...
        toast.error("Erro ao emitir nota fiscal. Por favor, tente novamente.", {
          position: "top-right",
          autoClose: 3000,
          hideProgressBar: false,
          closeOnClick: true,
      ...
      toast.error("Erro ao conectar ao servidor para emitir a nota fiscal.", {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    const { fullName, document, email, whatsapp, paymentMethod, product } =
      formData
    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center p-6 relative">
      ...
      {!submitted ? (
          ...
          >
            ...
            <div className="mb-6">
              <div className="bg-purple-600 p-4 rounded-lg text-center shadow-lg text-white font-bold text-lg">
                Early Adoption Pass
                <br />
                De <span className="line-through">R$ 3.567,00</span> por{" "}
                <span className="text-2xl">R$ 657,00</span>
                <br />
                Promoção termina em:{" "}
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
              <div className="bg-white p-6 rounded-lg shadow-lg text-gray-900 text-center">
                ...
                <p className="text-sm font-bold">
                  Nome: IORA PROCESSAMENTO DE DADOS LTDA
                </p>
                <p className="text-sm font-bold mb-4">
                  Chave Pix: 7bda06fb-55ac-4132-b6ef-8e5dd6a4d51e
                </p>
                <button
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-md text-center">
          ...
          <p className="mb-4">
            Forma de pagamento:{" "}
            {formData.paymentMethod === "pix" ? "Pix" : "Stripe"}
          </p>
